...
namespace appFoodDelivery.pagination
{
    ...
    public class OrderPagination<T> : List<T>
    {
        ...
        public OrderPagination(List<T> items, int count, int pageindex, int pagesize)
        {
            PageIndex = pageindex;
        ...
        public static OrderPagination<T> Create(IList<T> source, int pageindex, int pagesize)
        {
